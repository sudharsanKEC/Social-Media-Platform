...
function Popup({successMessage}){
    const navigate = useNavigate();
    return (
        <div className="max-w-xl border border-slate-200 bg-white mt-5 mx-auto shadow-lg rounded-2xl">
             ...
             <span className=" text-white"> ✓ </span>
              ...
              <div>
                <p className="font-black text-blue text-base">{successMessage}</p>
